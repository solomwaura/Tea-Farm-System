...
if(isset($_POST['login'])){
    ...
    if($results){
        ...
        if($data==1){
			...
			echo "<div class='alert alert-danger' style='width:80%; text-align:center; margin-right:auto; margin-left:auto;'>";
...
?>
				...
				<form action="login.php" method="post" class="login100-form validate-form">
					...
					<div class="flex-sb-m w-full p-b-30">
						<div>
                        <a href="../index.php"><i style="color:green;" class="fa fa-home fa-2x"></i></a>
						
                        </div>


						<div>
							<a href="resetpassword.php" style="font-size: 15px; text-decoration:none;" class="txt1">
