    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Produce Report</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                $sql10 = "SELECT users.*,produce.* FROM users CROSS JOIN produce WHERE users.usertype='user' AND 
             users.factoryid=produce.factoryid ORDER BY produce.date DESC";
